                        ...
                        <tr>
                          ...
                          <td>
                            @if($lokasi->status == 'aktif')
                              <button class="btn btn-sm btn-secondary btn-nonaktif" data-id="{{ $lokasi->id }}">Nonaktifkan</button>
                            @else
                              <button class="btn btn-sm btn-success btn-aktif" data-id="{{ $lokasi->id }}">Aktifkan</button>
                            @endif
                          </td>
                          <td>
                            <button class="btn btn-warning btn-edit" data-id="{{ $lokasi->id }}">Edit</button>
                            <button class="btn btn-danger btn-delete" data-id="{{ $lokasi->id }}">Hapus</button>
                          </td>
                        </tr>
                        @endforeach
                      </tbody>
