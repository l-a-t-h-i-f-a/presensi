...
<!DOCTYPE html>
<html lang="en">
<?php echo $__env->make('partial.headuser', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                  ...
                  <img src="<?php echo e(asset('adminpage')); ?>/template/images/absen1.jpg" alt="people">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo e($tanggal); ?></p>
                      <p>Selamat datang, <?php echo e($pegawai->nama); ?></p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo e($totalPresensi); ?></p>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo e($totalIzin); ?></p>
...
<?php /**PATH C:\laragon\www\absen-fiks\absensi\resources\views/dashboard.blade.php ENDPATH**/ ?>